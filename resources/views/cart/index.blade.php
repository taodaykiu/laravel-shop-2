    ...
    <script>
        $(document).ready(function() {
            ...
            $('.btn-remove').click(function() {
                ...
                swal({
                    title: '确认要将该商品移除？', icon: 'warning', buttons: ['取消', '确定'], dangerMode: true,
            ...
            $('.btn-create-order').click(function() {
                ...
                var req = {
                    address_id: $('#order-form').find('select[name=address]').val(), items: [], remark: $('#order-form').find('textarea[name=remark]').val(), coupon_code: $('input[name=coupon_code]').val(), // 从优惠码输入框中获取优惠码
                };
                ...
                $('table tr[data-id]').each(function() {
                    ...
                    req.items.push({
                        sku_id: $(this).data('id'), amount: $input.val(),
                    });
                });
